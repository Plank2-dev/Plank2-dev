...
print()
print(colored("Author   : Chris 'Plank.dev' Abou-cyberhunter", 'green'))
print(colored("Website : https://plankton4you.vercel.app", 'magenta'))
print(colored("Github   : https://github.com/Plank2-dev", 'red'))
print(colored("YouTube : https://www.youtube.com/channel/UC7-AsunT7zO-ny5-U8glqkw", 'green'))
print(colored("Linkedin : https://www.linkedin.com/company/plank-dev-ethical-hacking/", 'magenta'))
